...
exports.handler = async (event, context) => {
  ...
  const fetchData = async () => {
    try {
      ...
      // console.log({"nodewatch-consensus-clients_response": response});
      console.log({"dataSource":"nodewatch-consensus-clients","metricValue":metricValue});
      return metricValue;
    } catch (err) {
      return {
  ...
  function getMetricValue(obj, n) {
    ...
    let arr = obj["data"]["aggregateByAgentName"];
    let totalSize = 0;
    let sampleSize = 0;
    let metricValue;
